function About() {
  return (
    <section id="about" className="flex flex-col px-4 md:px-8 lg:px-16 pt-[40px] md:pt-[100px]">
      
      {/* About me */}
      <h2 className="text-xl md:text-[32px] font-bold text-black md:pb-[50px]">
        About me
      </h2>

      {/* Photo (left) */}
      <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-16 mt-6 md:mt-8">
        {/* Photo */}
        <div className="flex justify-center md:justify-start w-full md:w-1/2">
          <img 
            src="/images/photoAbout.png" 
            alt="Nick photo circle"
            className="w-full max-w-[290px] md:max-w-[412px] h-auto object-cover rounded-lg"
          />
        </div>
        ...
        <div className="flex flex-col w-full md:w-1/2 gap-4">
          ...
          {/* Description */}
          <p className="text-sm md:text-base text-black leading-[150%] md:max-w-[400px] md:pb-[40px]">
          ...
          {/* Button (web and tablet) */}
          <button className="hidden md:flex items-center gap-2 px-[13px] py-[9px] bg-[#7E3AF2] rounded-[50px] w-[140px] justify-center">
      ...
      <div className="flex flex-col lg:flex-row w-full gap-8 pt-[40px] md:pt-[60px] md:pb-[80px]">
        ...
        <div className="flex flex-col w-full lg:w-1/2 gap-3">
          <h3 className="text-xl md:text-[24px] font-semibold text-black pb-[17px]">
            Education & Experience
          </h3>
          <div className="flex flex-col w-full max-w-[290px] md:max-w-full gap-3">
      ...
      {/* Button (mobile) */}
      <div className="flex md:hidden justify-start pt-[30px] pb-[120px]">
        <button className="flex items-center gap-2 px-[13px] py-[9px] bg-[#7E3AF2] rounded-[50px] w-[140px] justify-center">
          <span className="text-sm font-semibold text-white leading-[150%]">
            Get in touch
          </span>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
