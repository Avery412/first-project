function Contacts() {
  return (
    <section id="contacts" className="relative w-full min-h-[740px] px-4 pt-[60px] pb-[60px] overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[320px] md:max-w-[712px] lg:max-w-[764px] mx-auto bg-white rounded-[20px] p-6 md:p-10 lg:p-12">
        {/* Title */}
        <h2 className="text-xl md:text-[32px] font-bold text-black pb-[35px] pt-[24px]">
        ...
        <form className="flex flex-col w-full gap-4">
          ...
          <div className="flex flex-col md:flex-row w-full gap-4">
            {/* Name and surname */}
            <div className="flex flex-col w-full md:w-1/2 gap-1 pb-[8px]">
        ...
        <section className="flex flex-col items-start pt-[29px] pb-[25px]">
          <button className="flex items-center gap-2 px-[13px] py-[9px] bg-[#7E3AF2] rounded-[50px]">
            {/* Mobile version */}
            <span className="text-sm font-semibold text-white leading-[150%] md:hidden">
              Get in touch
            </span>
            {/* Web and tablet version */}
            <span className="hidden md:inline text-sm md:text-base font-semibold text-white leading-[150%]">
              Submit
            </span>
